...
##########################################################################
                     API="api1" 
                     google_sheet="https://docs.google.com/spreadsheets/d/1ul4N4HhT58l-fchs9AKKTMkwBZg32vZSmfOeUec7edY/edit?gid=413654287#gid=413654287" 
                     id="7"                 #เปลี่ยน id ทุกครั้งที่ยิง
                     user="12000";            #จำนวนผู้ใช้งาน
                     duration="1";         #วินาที
